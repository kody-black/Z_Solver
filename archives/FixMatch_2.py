...
parser.add_argument('--dataset', default='yandex', type=str, help="the name of dataset")
parser.add_argument('--label', default="10000.txt", type=str, help='the labels of captcha images used for training')
...
parser.add_argument('--epoch', default=400, type=int, help='the number of training epochs')
...
for epoch in range(NUM_EPOCHS):
    ...
    for num_iter, (inputs_u_w, inputs_u_s) in enumerate(dataloader_train_nolabeled):
        inputs_x, targets_x = next(iter_label)
